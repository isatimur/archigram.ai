    ...
    <div className="h-screen w-screen bg-[#09090b] text-white overflow-y-auto overflow-x-hidden landing-grid relative font-sans scroll-smooth">
      ...
      <header className="fixed top-0 w-full z-50 border-b border-white/5 bg-[#09090b]/80 backdrop-blur-xl px-6 h-20 flex items-center justify-between" role="banner">
         ...
         <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-zinc-400" role="navigation">
            {/* Simple Tools Dropdown Simulation using Hover */}
            <div className="relative group">
                ...
                <div className="absolute top-full left-0 w-48 bg-[#18181b]/95 backdrop-blur-xl border border-white/10 rounded-xl shadow-2xl overflow-hidden opacity-0 scale-95 -translate-y-2 pointer-events-none group-hover:opacity-100 group-hover:scale-100 group-hover:translate-y-0 group-hover:pointer-events-auto transition-all duration-200 p-1">
                    <button onClick={() => onNavigate('app')} className="flex items-center gap-2 w-full px-4 py-2 hover:bg-white/5 rounded-lg text-left text-zinc-300 hover:text-white transition-colors">
                        <Rocket className="w-4 h-4 text-indigo-400" /> Mermaid Studio
                    </button>
                    <button onClick={() => onNavigate('plantuml')} className="flex items-center gap-2 w-full px-4 py-2 hover:bg-white/5 rounded-lg text-left text-zinc-300 hover:text-white transition-colors">
                        <Binary className="w-4 h-4 text-emerald-400" /> PlantUML Studio
                    </button>
                </div>
            </div>
      ...
      <main>
        ...
        <section className="relative pt-40 pb-20 px-6 max-w-7xl mx-auto flex flex-col items-center text-center z-10">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-500/10 border border-indigo-500/20 text-indigo-400 text-xs font-medium mb-8 animate-fade-in">
                ...
                <span>v0.2 Now Available • Powered by Gemini 3 Flash</span>
            </div>
