...
const LandingPage: React.FC<LandingPageProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="h-screen w-screen bg-[#09090b] text-white overflow-y-auto overflow-x-hidden relative font-sans scroll-smooth group/landing">
      ...
      <header
        className="fixed top-0 w-full z-50 border-b border-white/5 bg-[#09090b]/80 backdrop-blur-xl px-6 h-20 flex items-center justify-between transition-all duration-300"
        role="banner"
      >
        <div
        ...
        >
          ...
          <div>
            ...
            <p className="text-[10px] text-zinc-500 tracking-widest uppercase font-mono leading-none group-hover:text-indigo-400 transition-colors">
        ...
        >
            ...
            >
              <div className="p-2 space-y-1">
                <button
                  ...
                  className="flex items-center gap-3 w-full p-3 hover:bg-white/5 rounded-xl text-left transition-colors group/item"
                >
          ...
          <button
            ...
            className="hover:text-indigo-400 text-indigo-200 transition-colors flex items-center gap-1.5"
          >
      ...
      <main className="relative z-10">
        ...
        <section className="relative pt-48 pb-24 px-6 max-w-7xl mx-auto flex flex-col items-center text-center">
          ...
          <h2
            className="text-lg md:text-xl text-zinc-400 max-w-2xl mb-12 leading-relaxed animate-slide-up opacity-0"
            style={{ animationDelay: '0.2s', animationFillMode: 'forwards' }}
          >
            The intelligent canvas for modern engineering. Generate{' '}
            <strong>Mermaid.js and PlantUML</strong> diagrams with code-first precision and 100B
            parameter AI models.
          </h2>

          <div
            className="flex flex-col sm:flex-row items-center gap-5 animate-slide-up opacity-0"
        ...
        <section
          className="max-w-6xl mx-auto px-6 mb-40 relative z-10 animate-slide-up opacity-0"
        ...
        >
          ...
          <div className="flex justify-center gap-8 mt-8 text-zinc-500 text-xs font-mono tracking-widest uppercase opacity-70">
            <span className="flex items-center gap-2">
              <CheckCircle2 className="w-3 h-3 text-indigo-500" /> Mermaid.js Native
            </span>
            <span className="flex items-center gap-2">
              <CheckCircle2 className="w-3 h-3 text-emerald-500" /> PlantUML Support
            </span>
          </div>
        </section>
                  ...
                  <article className="flex gap-6 group">
                    ...
                    <div>
                      ...
                      <p className="text-zinc-400 text-base mt-2 leading-relaxed">
                        Map out API gateways, microservices, and database relationships (ERD) before
      ...
      <footer className="border-t border-white/5 bg-[#050507] py-16">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-zinc-500 text-sm max-w-sm leading-relaxed mb-6">
              ...
              engineers. Empowering the next generation of system design.
            </p>
            <div className="max-w-sm">
              <p className="text-xs text-zinc-400 font-medium mb-2">Stay in the loop</p>
        ...
        <div className="max-w-7xl mx-auto px-6 pt-8 border-t border-white/5 text-center text-zinc-600 text-sm flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex flex-col md:flex-row items-center gap-2">
            ...
            >
              Part of{' '}
              <span className="font-bold text-zinc-500 group-hover:text-white transition-colors underline decoration-dotted underline-offset-4 decoration-zinc-700">
                Beyond 9to6
              </span>
            </a>
          </div>
...
const FaqItem: React.FC<FaqItemProps> = ({ question, answer }) => (
  <div
    className="bg-zinc-900/40 border border-white/5 rounded-2xl p-8 text-left hover:border-indigo-500/20 transition-colors"
    itemScope
    itemProp="mainEntity"
  ...
  >
    ...
    <div itemScope itemProp="acceptedAnswer" itemType="https://schema.org/Answer">
      <p
        className="text-zinc-400 text-base leading-relaxed pl-8 border-l-2 border-white/5 ml-2.5"
        itemProp="text"
      >
        {answer}
      </p>
