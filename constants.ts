...
export const COMMUNITY_DATA = [
  ...
  },
  {
    ...
    author: 'DataEng42',
    description:
      'Apache Kafka-based streaming architecture with Flink processing and exactly-once semantics.',
    likes: 720,
    views: 4100,
  ...
  },
  {
    ...
    likes: 640,
    views: 3800,
    tags: ['Event-Driven', 'Async', 'Kafka', 'Microservices'],
    createdAt: '1w ago',
...
// ═══════════════════════════════════════════
// SEED PROMPTS — Prompt Marketplace fallback
// ═══════════════════════════════════════════
